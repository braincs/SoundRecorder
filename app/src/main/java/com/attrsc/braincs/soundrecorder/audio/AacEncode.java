...
public class AacEncode {
    ...
    public AacEncode() {
        ...
        MediaFormat mediaFormat = MediaFormat.createAudioFormat(
                MediaFormat.MIMETYPE_AUDIO_AAC, 16000, 1);

        mediaFormat.setInteger(MediaFormat.KEY_CHANNEL_MASK, AudioFormat.ENCODING_PCM_16BIT);//fixme
...
//        final int kBitRates[] = {32000, 64000, 96000, 128000};
    ...
    public byte[] offerEncoder(byte[] input) throws Exception {
        ...
        while (outputBufferIndex >= 0) {
            ...
            ADTSUtils.addADTStoPacket(ADTSUtils.getSampleRateType(sampleRate), channelCount, outData, outPacketSize);
//            addADTStoPacket(outData, outPacketSize);
//            ADTSUtils.addADTStoPacket(ADTSUtils.getSampleRateType(16000), 1, outData, outPacketSize);
